...
export default function MenuCard({ item }: { item: MenuItem }) {
  ...
  return (
    <article
      ...
      className={`group rounded-xl2 border border-white/50 bg-white/45 p-3 shadow-soft backdrop-blur-md transition-shadow duration-200 hover:shadow-card sm:bg-white/70 sm:backdrop-blur-md ${
