...
export default function MenuCard({ item }: { item: MenuItem }) {
  ...
  return (
    <article
      ...
      className={`group rounded-xl2 border border-white/70 bg-gradient-to-br from-white/55 to-white/35 p-3 shadow-[0_8px_32px_-8px_rgba(20,80,60,0.3)] ring-1 ring-inset ring-white/40 backdrop-blur-[40px] transition-shadow duration-200 hover:shadow-card lg:border-white/60 lg:from-white/40 lg:via-white/28 lg:to-white/18 lg:shadow-[0_22px_70px_-28px_rgba(20,80,60,0.5)] lg:ring-white/50 lg:backdrop-blur-[150px] lg:backdrop-saturate-150 ${
